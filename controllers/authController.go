...
const SecretKey = "3426cf9a-350e-42ed-9f1f-e6d13832e635"
...
func Register(c *fiber.Ctx) error {
	...
	user := models.User{
		Name:  data["name"],
		Email: data["email"],
		// Password: string(password), also make change in user.go
		Password: password,
	}
...
func User(c *fiber.Ctx) error {
	...
	//  convert from claims as claims doee=snt returns issues=r
